...
1) createmovie-info.py reads movies title from movie.txt, looks up IMDB using the imdbpy library, and saves the corresponding features for the movie in movie-info.txt
